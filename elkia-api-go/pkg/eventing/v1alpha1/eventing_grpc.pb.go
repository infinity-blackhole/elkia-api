...
const (
	Auth_AuthInteract_FullMethodName = "/io.elkia.eventing.v1alpha1.Auth/AuthInteract"
	Auth_AuthWatch_FullMethodName    = "/io.elkia.eventing.v1alpha1.Auth/AuthWatch"
)
...
func (c *authClient) AuthWatch(ctx context.Context, in *AuthWatchRequest, opts ...grpc.CallOption) (Auth_AuthWatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Auth_ServiceDesc.Streams[1], Auth_AuthWatch_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "elkia-api/eventing/v1alpha1/eventing.proto",
}

const (
	Gateway_ChannelInteract_FullMethodName = "/io.elkia.eventing.v1alpha1.Gateway/ChannelInteract"
	Gateway_ChannelWatch_FullMethodName    = "/io.elkia.eventing.v1alpha1.Gateway/ChannelWatch"
)
...
func (c *gatewayClient) ChannelWatch(ctx context.Context, in *ChannelWatchRequest, opts ...grpc.CallOption) (Gateway_ChannelWatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Gateway_ServiceDesc.Streams[1], Gateway_ChannelWatch_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
