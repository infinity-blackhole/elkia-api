...
get_all_source_basenames() -> ["fleet.proto"].
...
%% functions.
get_all_proto_names() -> ["fleet"].


get_msg_containment("fleet") ->
    [auth_handoff_request,
     auth_handoff_response,
     auth_login_request,
     auth_login_response,
...
get_pkg_containment("fleet") -> 'io.elkia.fleet.v1alpha1';
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).


get_service_containment("fleet") -> ['io.elkia.fleet.v1alpha1.Cluster', 'io.elkia.fleet.v1alpha1.Presence'];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).


get_rpc_containment("fleet") ->
...
get_enum_containment("fleet") -> [];
get_enum_containment(P) -> error({gpb_error, {badproto, P}}).


get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.Member">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.SessionPutRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.SessionGetRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.SessionDeleteRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.MemberUpdateRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.MemberRemoveRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.MemberListRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.MemberAddRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.AuthRefreshLoginRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.AuthLogoutRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.AuthLoginRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.AuthHandoffRequest">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.SessionPutResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.SessionGetResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.SessionDeleteResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.MemberUpdateResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.MemberRemoveResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.MemberListResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.MemberAddResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.AuthRefreshLoginResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.AuthLogoutResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.AuthLoginResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.AuthHandoffResponse">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.Session">>) -> "fleet";
get_proto_by_msg_name_as_fqbin(E) -> error({gpb_error, {badmsg, E}}).


get_proto_by_service_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.Cluster">>) -> "fleet";
get_proto_by_service_name_as_fqbin(<<"io.elkia.fleet.v1alpha1.Presence">>) -> "fleet";
...
get_protos_by_pkg_name_as_fqbin(<<"io.elkia.fleet.v1alpha1">>) -> ["fleet"];
