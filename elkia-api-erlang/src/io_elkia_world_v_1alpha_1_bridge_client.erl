...
%% @doc Unary RPC
-spec character_add(world_pb:character_add_request()) ->
    {ok, world_pb:character_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
character_add(Input) ->
    character_add(ctx:new(), Input, #{}).

-spec character_add(ctx:t() | world_pb:character_add_request(), world_pb:character_add_request() | grpcbox_client:options()) ->
    {ok, world_pb:character_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec character_add(ctx:t(), world_pb:character_add_request(), grpcbox_client:options()) ->
    {ok, world_pb:character_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec character_remove(world_pb:character_remove_request()) ->
    {ok, world_pb:character_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
character_remove(Input) ->
    character_remove(ctx:new(), Input, #{}).

-spec character_remove(ctx:t() | world_pb:character_remove_request(), world_pb:character_remove_request() | grpcbox_client:options()) ->
    {ok, world_pb:character_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec character_remove(ctx:t(), world_pb:character_remove_request(), grpcbox_client:options()) ->
    {ok, world_pb:character_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec character_update(world_pb:character_update_request()) ->
    {ok, world_pb:character_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
character_update(Input) ->
    character_update(ctx:new(), Input, #{}).

-spec character_update(ctx:t() | world_pb:character_update_request(), world_pb:character_update_request() | grpcbox_client:options()) ->
    {ok, world_pb:character_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec character_update(ctx:t(), world_pb:character_update_request(), grpcbox_client:options()) ->
    {ok, world_pb:character_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec character_list(world_pb:character_list_request()) ->
    {ok, world_pb:character_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
character_list(Input) ->
    character_list(ctx:new(), Input, #{}).

-spec character_list(ctx:t() | world_pb:character_list_request(), world_pb:character_list_request() | grpcbox_client:options()) ->
    {ok, world_pb:character_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec character_list(ctx:t(), world_pb:character_list_request(), grpcbox_client:options()) ->
    {ok, world_pb:character_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
