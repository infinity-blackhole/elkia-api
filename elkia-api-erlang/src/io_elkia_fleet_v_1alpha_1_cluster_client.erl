...
%% @doc Unary RPC
-spec member_add(fleet_pb:member_add_request()) ->
    {ok, fleet_pb:member_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
member_add(Input) ->
    member_add(ctx:new(), Input, #{}).

-spec member_add(ctx:t() | fleet_pb:member_add_request(), fleet_pb:member_add_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:member_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec member_add(ctx:t(), fleet_pb:member_add_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:member_add_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec member_remove(fleet_pb:member_remove_request()) ->
    {ok, fleet_pb:member_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
member_remove(Input) ->
    member_remove(ctx:new(), Input, #{}).

-spec member_remove(ctx:t() | fleet_pb:member_remove_request(), fleet_pb:member_remove_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:member_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec member_remove(ctx:t(), fleet_pb:member_remove_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:member_remove_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec member_update(fleet_pb:member_update_request()) ->
    {ok, fleet_pb:member_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
member_update(Input) ->
    member_update(ctx:new(), Input, #{}).

-spec member_update(ctx:t() | fleet_pb:member_update_request(), fleet_pb:member_update_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:member_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec member_update(ctx:t(), fleet_pb:member_update_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:member_update_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec member_list(fleet_pb:member_list_request()) ->
    {ok, fleet_pb:member_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
member_list(Input) ->
    member_list(ctx:new(), Input, #{}).

-spec member_list(ctx:t() | fleet_pb:member_list_request(), fleet_pb:member_list_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:member_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec member_list(ctx:t(), fleet_pb:member_list_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:member_list_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
