...
%% @doc Unary RPC
-spec auth_login(fleet_pb:auth_login_request()) ->
    {ok, fleet_pb:auth_login_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
auth_login(Input) ->
    auth_login(ctx:new(), Input, #{}).

-spec auth_login(ctx:t() | fleet_pb:auth_login_request(), fleet_pb:auth_login_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:auth_login_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec auth_login(ctx:t(), fleet_pb:auth_login_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:auth_login_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec auth_refresh_login(fleet_pb:auth_refresh_login_request()) ->
    {ok, fleet_pb:auth_refresh_login_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
auth_refresh_login(Input) ->
    auth_refresh_login(ctx:new(), Input, #{}).

-spec auth_refresh_login(ctx:t() | fleet_pb:auth_refresh_login_request(), fleet_pb:auth_refresh_login_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:auth_refresh_login_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec auth_refresh_login(ctx:t(), fleet_pb:auth_refresh_login_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:auth_refresh_login_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec auth_handoff(fleet_pb:auth_handoff_request()) ->
    {ok, fleet_pb:auth_handoff_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
auth_handoff(Input) ->
    auth_handoff(ctx:new(), Input, #{}).

-spec auth_handoff(ctx:t() | fleet_pb:auth_handoff_request(), fleet_pb:auth_handoff_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:auth_handoff_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec auth_handoff(ctx:t(), fleet_pb:auth_handoff_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:auth_handoff_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec auth_logout(fleet_pb:auth_logout_request()) ->
    {ok, fleet_pb:auth_logout_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
auth_logout(Input) ->
    auth_logout(ctx:new(), Input, #{}).

-spec auth_logout(ctx:t() | fleet_pb:auth_logout_request(), fleet_pb:auth_logout_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:auth_logout_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec auth_logout(ctx:t(), fleet_pb:auth_logout_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:auth_logout_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec session_get(fleet_pb:session_get_request()) ->
    {ok, fleet_pb:session_get_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
session_get(Input) ->
    session_get(ctx:new(), Input, #{}).

-spec session_get(ctx:t() | fleet_pb:session_get_request(), fleet_pb:session_get_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:session_get_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec session_get(ctx:t(), fleet_pb:session_get_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:session_get_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec session_put(fleet_pb:session_put_request()) ->
    {ok, fleet_pb:session_put_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
session_put(Input) ->
    session_put(ctx:new(), Input, #{}).

-spec session_put(ctx:t() | fleet_pb:session_put_request(), fleet_pb:session_put_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:session_put_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec session_put(ctx:t(), fleet_pb:session_put_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:session_put_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
%% @doc Unary RPC
-spec session_delete(fleet_pb:session_delete_request()) ->
    {ok, fleet_pb:session_delete_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
session_delete(Input) ->
    session_delete(ctx:new(), Input, #{}).

-spec session_delete(ctx:t() | fleet_pb:session_delete_request(), fleet_pb:session_delete_request() | grpcbox_client:options()) ->
    {ok, fleet_pb:session_delete_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
...
-spec session_delete(ctx:t(), fleet_pb:session_delete_request(), grpcbox_client:options()) ->
    {ok, fleet_pb:session_delete_response(), grpcbox:metadata()} | grpcbox_stream:grpc_error_response() | {error, any()}.
